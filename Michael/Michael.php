...
// Consulta SQL para obtener la biografía de Michael Jackson
$sql_biografia = "SELECT Descripcion, Imagen_URL FROM Biografia WHERE Artista = 'Michael Jackson'";
...
if ($result_biografia->num_rows > 0) {
    ...
    $biografia = "No se encontró la biografía de Michael Jackson";
}

// Consulta SQL para obtener la discografía de Michael Jackson ordenada por año ascendente
$sql_discografia = "SELECT * FROM Discografia WHERE Artista = 'Michael Jackson' ORDER BY Year ASC";
$result_discografia = $conn->query($sql_discografia);

// Consulta SQL para obtener la música de Michael Jackson
$sql_musica = "SELECT Spotify FROM Musica WHERE Artista = 'Michael Jackson'";
$result_musica = $conn->query($sql_musica);

// Consulta SQL para obtener los elementos multimedia de Michael Jackson
$sql_multimedia = "SELECT URL FROM Multimedia WHERE Artista = 'Michael Jackson'";
...
<head>
    ...
    <link rel="stylesheet" href="estiloMichael.css">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            if ($result_discografia && $result_discografia->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='3'>No se encontraron álbumes en la discografía de Michael Jackson</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
            ...
            <div class="contenedor">
                ...
                <div class="contenido">
                    ...
                    if ($result_musica && $result_musica->num_rows > 0) {
                        ...
                        echo "No se encontraron enlaces de Spotify para Michael Jackson";
                    }
                    ?>
                </div>
            </div>
            <div class="contenedor">
                ...
                <div class="contenido">
                    ...
                    if ($result_multimedia && $result_multimedia->num_rows > 0) {
                        ...
                        echo "No se encontraron elementos multimedia para Michael Jackson";
                    }
                    ?>
                </div>
            </div>
