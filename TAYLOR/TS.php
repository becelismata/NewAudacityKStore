...
$sql_biografia = "SELECT Descripcion, Imagen_URL FROM Biografia WHERE Artista = '$artista'";
...
if ($result_biografia->num_rows > 0) {
    ...
    $biografia = "No se encontró la biografía de Taylor Swift";
}

// Consulta SQL para obtener la discografía de Taylor Swift ordenada por año ascendente
$sql_discografia = "SELECT * FROM Discografia WHERE Artista = 'Taylor Swift' ORDER BY Year ASC";
$result_discografia = $conn->query($sql_discografia);

// Consulta SQL para obtener la música de Taylor Swift
$sql_musica = "SELECT Spotify FROM Musica WHERE Artista = 'Taylor Swift'";
$result_musica = $conn->query($sql_musica);

// Consulta SQL para obtener los elementos multimedia de Taylor Swift
$sql_multimedia = "SELECT URL FROM Multimedia WHERE Artista = 'Taylor Swift'";
...
<head>
    ...
    <link rel="stylesheet" href="estilotay.css">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            if ($result_discografia && $result_discografia->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='3'>No se encontraron álbumes en la discografía de Taylor Swift</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
            ...
            <div class="contenedor">
                ...
                <div class="contenido">
                    ...
                    if ($result_musica && $result_musica->num_rows > 0) {
                        ...
                        echo "No se encontraron enlaces de Spotify para Taylor Swift";
                    }
                    ?>
                </div>
            </div>
            <div class="contenedor">
                ...
                <div class="contenido">
                    ...
                    if ($result_multimedia && $result_multimedia->num_rows > 0) {
                        ...
                        echo "No se encontraron elementos multimedia para Taylor Swift";
                    }
                    ?>
                </div>
            </div>
