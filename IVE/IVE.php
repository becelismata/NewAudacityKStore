...
// Consulta SQL para obtener la biografía de IVE
$sql_biografia = "SELECT Descripcion, Imagen_URL FROM Biografia WHERE Artista = 'IVE'";
...
if ($result_biografia->num_rows > 0) {
    ...
    $biografia = "No se encontró la biografía de IVE";
}

// Consulta SQL para obtener la discografía de IVE ordenada por año ascendente
$sql_discografia = "SELECT * FROM Discografia WHERE Artista = 'IVE' ORDER BY Year ASC";
$result_discografia = $conn->query($sql_discografia);

// Consulta SQL para obtener la música de IVE
$sql_musica = "SELECT Spotify FROM Musica WHERE Artista = 'IVE'";
$result_musica = $conn->query($sql_musica);

// Consulta SQL para obtener los elementos multimedia de IVE
$sql_multimedia = "SELECT URL FROM Multimedia WHERE Artista = 'IVE'";
...
<head>
    ...
    <link rel="stylesheet" href="estiloive.css">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            if ($result_discografia && $result_discografia->num_rows > 0) {
                                ...
                                echo "<tr><td colspan='3'>No se encontraron álbumes en la discografía de IVE</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
            ...
            <div class="contenedor">
                ...
                <div class="contenido">
                    ...
                    if ($result_musica && $result_musica->num_rows > 0) {
                        ...
                        echo "No se encontraron enlaces de Spotify para IVE";
                    }
                    ?>
                </div>
            </div>
            <div class="contenedor">
                ...
                <div class="contenido">
                    ...
                    if ($result_multimedia && $result_multimedia->num_rows > 0) {
                        ...
                        echo "No se encontraron elementos multimedia para IVE";
                    }
                    ?>
                </div>
            </div>
